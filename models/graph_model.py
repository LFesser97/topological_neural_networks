...
from torch_geometric.nn import GCNConv, RGCNConv, SAGEConv, GatedGraphConv, GINConv, FiLMConv, global_mean_pool, GATv2Conv
...
class RGATConv(torch.nn.Module):
    def __init__(self, in_features, out_features, num_relations):
        ...
        for i in range(self.num_relations):
            convs.append(GATv2Conv(in_features, out_features))
