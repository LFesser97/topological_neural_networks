...
from torch_geometric.nn import GCNConv, RGCNConv, SAGEConv, GatedGraphConv, GINConv, FiLMConv, global_mean_pool, RGATConv
...
class RGATConv(torch.nn.Module):
    def __init__(self, in_features, out_features, num_relations):
        ...
        for i in range(self.num_relations):
            convs.append(RGATConv(in_features, out_features))
